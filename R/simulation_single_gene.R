...
#'
#' @export
simulateGenotype.s2s <- function(n_i, maf, prob_ref) {
...
#'
#' @export
simulateCisEffect.s2s <- function(n_i, maf, prob_ref, phi, prob_as, theta, baseline, r, p_error = NULL) {

  # simulate genotype
  meta <- simulateGenotype.s2s(n_i = n_i, maf = maf, prob_ref = prob_ref)
